...
<div class="goods">
  <div class="content-wrapper" ref="contentWrapper">
    <div>
      ...
      <div class="activity">
        <span class="title">优惠出行-限时抢</span>
...
export default {
  data () {
    return {
      types: [
        {name: '机票', src: 'static/icon/plane.png'},
        {name: '门票', src: 'static/icon/tickets.png'},
        {name: '酒店', src: 'static/icon/hotle.png'},
        {name: '周边游', src: 'static/icon/travel.png'},
        {name: '全球购', src: 'static/icon/shopping.png'},
      ],
