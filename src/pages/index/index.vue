  ...
  <div class="page">
    <div class="header">
      ...
      <div class="search" @click="searchVisible=true">
        ...
        <span class="text">搜索目的地/景点/酒店</span>
      </div>
      <div class="right">
    ...
    <mt-popup v-model="searchVisible" 
      ...
      <div class="input-block">
        <input type="text" class="search-input" placeholder="搜索目的地/景点/酒店">
...
export default {
  data () {
    return {
      navs: ['推荐','国外','国内','机票','酒店','门票','更多'],
      transitionName: 'slide-right',
      chooseItem: 0,
      searchVisible: false,
      leftVisible: false,
      lefts: ["我的订单","我的行程","二维码","更多"],
      hots: ["赏秋","丽水","杭州","三亚","重庆","贵阳","十一月去哪玩","香港","青岛","成都","南京","北京"]
    }
  },
  components: {
    navbar
