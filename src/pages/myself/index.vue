      ...
      <div>
        <div class="user-block">
          <div class="user-login">
            <div class="user-logo">
              <img src="../../assets/bg/timg.jpg" alt="">
            </div>
          ...
          <div class="user-mask">
            <img src="../../assets/bg/lazycatlogo.jpg" alt="">
          </div>
        ...
        <div class="contact-block">
          ...
          <div class="contact-text">
            <span style="color:red">Looking for internships</span> By: chao <br>
            Contact: <span style="color:#FE4070">905277569@qq.com</span> <br>
          </div>
        </div>
      </div>
    </div>
  ...
  data () {
    return {
      orderContent: [
        ...
        {src: 'static/mine/history.png', title: '处理中'},
        {src: 'static/mine/priceIcon2.png', title: '待出行'},
        {src: 'static/mine/priceIcon3.png', title: '待评价'},
        {src: 'static/mine/priceIcon5.png', title: '退款/售后'},
      ],
      fundContent: [
        {number:'0个', title: '红包'},
        {number:'0张', title: '汽车券'},
        {number:'0张', title: '飞机券'},
        {number:'0张', title: '火车券'},
        {number:'0张',title: '酒店优惠券'},
      ],
      jumeiContent1: [
        {title:'我的收藏', src: 'static/mine/colorIcon/icon1.png'},
        {title:'我的卡券', src: 'static/mine/colorIcon/icon2.png'},
        {title:'浏览记录', src: 'static/mine/colorIcon/icon3.png'},
        {title:'开售提醒', src: 'static/mine/colorIcon/icon4.png'}
      ],
      jumeiContent2: [
        {title:'我的会员卡', src: 'static/mine/colorIcon/icon20.png'},
        {title:'我的足迹', src: 'static/mine/colorIcon/icon21.png'},
        {title:'我的客服', src: 'static/mine/colorIcon/icon23.png'},
