<template lang="html">
  <transition name="fade">
    <div class="set-wrapper" ref="setWrapper">
      ...
      <div class="block b2">
       <mt-cell title="新消息通知" class="underline"></mt-cell>
        <mt-cell title="官方客服" class="underline"></mt-cell>
      </div>
      <div class="block b3">
        <mt-cell title="常见问题与反馈" class="underline"></mt-cell>
        <mt-cell title="推荐给好友" class="underline"></mt-cell>
        <mt-cell title="支持我们，打分评价" class="underline"></mt-cell>
        <mt-cell title="关于我们" ></mt-cell>
      </div>
      <div class="block b4">
